        ...
        <div
            ...
            <div className='max-w-7xl mx-auto'>
                <div className="text-start mb-10 px-5 lg:px-0 mt-10 lg:mt-0 ">
                   ...
                   <Link href={"/contacts"}> <button className="bg-green-500 hover:bg-green-700 rounded-sm text-white px-5 lg:px-10 py-2 lg:py-3 text-bold text-xl lg:text-2xl mt-4">Let&apos;s work togather</button></Link>

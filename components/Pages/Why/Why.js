    ...
    return (
        <div className='bg-we-deifferent text-white py-14 lg:py-24 flex items-center justify-center'>
            <div className='max-w-7xl mx-auto relative'>
                <h2 className='text-xl lg:text-4xl font-extrabold pb-5 px-5'>How we&apos;re different from the competition</h2>

                <div className='bg-gradient-to-r from-[#466e94] to-[#3f8c67] p-10 rounded-md  relative'>
                    <p className='text-sm lg:text-xl font-semibold our-speciality-text-bg px-5 lg:px-20 py-8'>When a consultancy and software development capability are under one roof, better decisions are made, maintenance costs are reduced, and software is delivered at a higher velocity.</p>
                </div>
        ...
        <div className='bg-[#F0F4F7] text-darkBg '>
            ...
            <div>
                <div className='bg-darkBg py-10 '>
                    <h2 className='text-2xl lg:text-5xl font-bold  text-white max-w-7xl mx-auto px-5'>Our philosophy</h2>
                </div>
                <div className='bg-[#F8F9FB]  '>
                    <div className='flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto py-14'>
                        ...
                        <div className='ikigai-container'>
                            <p className='ikigai-text'>Ikigai happens when
                                what you&apos;re good at
            ...
            <div className='bg-white '>
                <div className='max-w-7xl mx-auto py-14 px-5'>
                    <h2 className='text-2xl lg:text-5xl font-bold pb-3'>High performance teams have high ikigai</h2>
                    <h3 className='text-xl lg:text-3xl font-bold text-greenclr'>experienced people + love their work = productive</h3>

                    <p className='text-sm lg:text-base my-5'>When you assemble a team with high ikigai, magic happens. Experienced people who love their work are productive, tasks are done with high fidelity, and decisions are made with care.</p>

                    <p className='text-sm lg:text-base'>At SiliconMint, this is the foundation of how we assemble engineering teams: people who are deeply technical, love what they do, and have a passion for the craft of programming itself.</p>
                </div>
            ...
            <div className='bg-we-deifferent text-white py-24 flex items-center justify-center'>
                <div className='max-w-7xl mx-auto relative'>
                    <h2 className='text-center text-xl mb-2'>Stay small, stay hungry</h2>

                    <div className=' ikigai-container'>
                        <p className=' ikigai-text'><span className='text-greenclr'>You don&apos;t need a large team </span> to accomplish great things. Conversely, great things are accomplished by small teams.</p>
                    </div>

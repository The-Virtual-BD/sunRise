...
export const ourBlogs = [
	{
		...
		blogTime: "18 April, 2023",
		bloggerImg: "/images/img-photo-Brad-Garlinghouse.jpg",
		blogTitle: "What is a Programming Language? 1",
		blogSubTitle:
			"Language is a mode of communication that is used to share ideas, opinions with each other. For example, if we want to teach someone, we need a language that is understandable by both communicators.",
		blogDetails:
			"Language is a mode of communication that is used to share ideas, opinions with each other. For example, if we want to teach someone, we need a language that is understandable by both communicators.Language is a mode of communication that is used to share ideas, opinions with each other. For example, if we want to teach someone, we need a language that is understandable by both communicators.Language is a mode of communication that is used to share ideas, opinions with each other. For example, if we want to teach someone, we need a language that is understandable by both communicators.Language is a mode of communication that is used to share ideas, opinions with each other. For example, if we want to teach someone, we need a language that is understandable by both communicators.",
		blogImg: "/images/bg-si-02.jpg",
	},
	{
		id: 2,
		blogCategory: "Laravel",
		bloggerName: "Michel Uber",
		blogTime: "18 April, 2023",
		bloggerImg: "/images/img-photo-Brad-Garlinghouse.jpg",
		blogTitle: "What is a Programming Language? 1",
		blogSubTitle:
